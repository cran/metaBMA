...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'string', line 78, column 0 to column 45)",
                                                      " (in 'string', line 82, column 0 to column 20)",
                                                      " (in 'string', line 92, column 2 to column 58)",
                                                      " (in 'string', line 91, column 28 to line 93, column 1)",
                                                      " (in 'string', line 91, column 7 to line 93, column 1)",
                                                      " (in 'string', line 90, column 2 to column 62)",
                                                      " (in 'string', line 89, column 28 to line 91, column 1)",
                                                      " (in 'string', line 89, column 7 to line 93, column 1)",
                                                      " (in 'string', line 88, column 2 to column 99)",
                                                      " (in 'string', line 87, column 28 to line 89, column 1)",
                                                      " (in 'string', line 87, column 7 to line 93, column 1)",
                                                      " (in 'string', line 86, column 2 to column 76)",
                                                      " (in 'string', line 85, column 28 to line 87, column 1)",
                                                      " (in 'string', line 85, column 7 to line 93, column 1)",
                                                      " (in 'string', line 84, column 2 to column 59)",
                                                      " (in 'string', line 83, column 20 to line 85, column 1)",
                                                      " (in 'string', line 83, column 0 to line 93, column 1)",
                                                      " (in 'string', line 95, column 2 to column 50)",
                                                      ...
                                                      " (in 'string', line 22, column 0 to column 26)",
                                                      " (in 'string', line 23, column 0 to column 20)",
                                                      " (in 'string', line 24, column 0 to column 19)",
                                                      " (in 'string', line 27, column 2 to column 21)",
                                                      " (in 'string', line 29, column 7 to column 8)",
                                                      " (in 'string', line 29, column 0 to column 14)",
                                                      " (in 'string', line 32, column 4 to column 21)",
                                                      " (in 'string', line 31, column 2 to line 32, column 21)",
                                                      " (in 'string', line 30, column 10 to line 33, column 1)",
                                                      " (in 'string', line 30, column 0 to line 33, column 1)",
                                                      " (in 'string', line 71, column 4 to line 72, column 82)",
                                                      " (in 'string', line 70, column 9 to line 73, column 3)",
                                                      " (in 'string', line 69, column 4 to column 18)",
                                                      " (in 'string', line 68, column 44 to line 70, column 3)",
                                                      " (in 'string', line 68, column 2 to line 73, column 3)",
                                                      " (in 'string', line 67, column 28 to line 74, column 1)",
                                                      " (in 'string', line 67, column 7 to line 74, column 1)",
                                                      " (in 'string', line 63, column 4 to line 64, column 86)",
                                                      " (in 'string', line 62, column 9 to line 65, column 3)",
                                                      " (in 'string', line 61, column 4 to column 18)",
                                                      " (in 'string', line 60, column 44 to line 62, column 3)",
                                                      " (in 'string', line 60, column 2 to line 65, column 3)",
                                                      " (in 'string', line 59, column 28 to line 67, column 1)",
                                                      " (in 'string', line 59, column 7 to line 74, column 1)",
                                                      " (in 'string', line 56, column 4 to column 47)",
                                                      " (in 'string', line 55, column 9 to line 57, column 3)",
                                                      " (in 'string', line 54, column 4 to column 18)",
                                                      " (in 'string', line 53, column 41 to line 55, column 3)",
                                                      " (in 'string', line 53, column 2 to line 57, column 3)",
                                                      " (in 'string', line 52, column 28 to line 59, column 1)",
                                                      " (in 'string', line 52, column 7 to line 74, column 1)",
                                                      " (in 'string', line 48, column 4 to line 49, column 100)",
                                                      " (in 'string', line 47, column 9 to line 50, column 3)",
                                                      " (in 'string', line 46, column 4 to column 18)",
                                                      " (in 'string', line 45, column 47 to line 47, column 3)",
                                                      " (in 'string', line 45, column 2 to line 50, column 3)",
                                                      " (in 'string', line 44, column 28 to line 52, column 1)",
                                                      " (in 'string', line 44, column 7 to line 74, column 1)",
                                                      " (in 'string', line 40, column 4 to line 41, column 83)",
                                                      " (in 'string', line 39, column 9 to line 42, column 3)",
                                                      " (in 'string', line 38, column 4 to column 18)",
                                                      " (in 'string', line 37, column 47 to line 39, column 3)",
                                                      " (in 'string', line 37, column 2 to line 42, column 3)",
                                                      " (in 'string', line 36, column 20 to line 44, column 1)",
                                                      " (in 'string', line 36, column 0 to line 74, column 1)"};
#include <stan_meta_header.hpp>
class model_random_H0 final : public model_base_crtp<model_random_H0> {
private:
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_random_H0"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_random_H0_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      }
      {
        ...
        lp_accum__.add(
          normal_lpdf<false>(y, 0, stan::math::sqrt(add(SE2, pow(tau, 2)))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_random_H0_namespace::model_random_H0;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_random_H0_namespace::profiles__;
}
#endif
#endif
