...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 129, column 0 to column 18)",
                                                      " (in 'string', line 139, column 2 to column 52)",
                                                      " (in 'string', line 138, column 26 to line 140, column 1)",
                                                      " (in 'string', line 138, column 7 to line 140, column 1)",
                                                      " (in 'string', line 137, column 2 to column 56)",
                                                      " (in 'string', line 136, column 26 to line 138, column 1)",
                                                      " (in 'string', line 136, column 7 to line 140, column 1)",
                                                      " (in 'string', line 135, column 2 to column 87)",
                                                      " (in 'string', line 134, column 26 to line 136, column 1)",
                                                      " (in 'string', line 134, column 7 to line 140, column 1)",
                                                      " (in 'string', line 133, column 2 to column 68)",
                                                      " (in 'string', line 132, column 26 to line 134, column 1)",
                                                      " (in 'string', line 132, column 7 to line 140, column 1)",
                                                      " (in 'string', line 131, column 2 to column 53)",
                                                      " (in 'string', line 130, column 18 to line 132, column 1)",
                                                      " (in 'string', line 130, column 0 to line 140, column 1)",
                                                      " (in 'string', line 142, column 0 to column 20)",
                                                      " (in 'string', line 152, column 2 to column 58)",
                                                      " (in 'string', line 151, column 28 to line 153, column 1)",
                                                      " (in 'string', line 151, column 7 to line 153, column 1)",
                                                      " (in 'string', line 150, column 2 to column 62)",
                                                      " (in 'string', line 149, column 28 to line 151, column 1)",
                                                      " (in 'string', line 149, column 7 to line 153, column 1)",
                                                      " (in 'string', line 148, column 2 to column 99)",
                                                      " (in 'string', line 147, column 28 to line 149, column 1)",
                                                      " (in 'string', line 147, column 7 to line 153, column 1)",
                                                      " (in 'string', line 146, column 2 to column 76)",
                                                      " (in 'string', line 145, column 28 to line 147, column 1)",
                                                      " (in 'string', line 145, column 7 to line 153, column 1)",
                                                      " (in 'string', line 144, column 2 to column 59)",
                                                      " (in 'string', line 143, column 20 to line 145, column 1)",
                                                      " (in 'string', line 143, column 0 to line 153, column 1)",
...
class model_random_dstudy final : public model_base_crtp<model_random_dstudy> {
private:
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_random_dstudy"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_random_dstudy_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      assign(dstudy, nil_index_list(), add(d, multiply(tau, delta)),
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"d\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"parameters\"},{\"name\":\"dstudy\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_random_dstudy_namespace::model_random_dstudy;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_random_dstudy_namespace::profiles__;
}
#endif
#endif
