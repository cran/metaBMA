...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_random_ordered");
    ...
    reader.add_event(14, 1, "restart", "model_random_ordered");
    ...
    reader.add_event(19, 4, "restart", "model_random_ordered");
    ...
    reader.add_event(22, 5, "restart", "model_random_ordered");
...
class model_random_ordered
  : public stan::model::model_base_crtp<model_random_ordered> {
private:
        int N;
        vector_d y;
        vector_d SE;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("dstudy", "N", N);
        context__.validate_dims("parameter initialization", "dstudy", "vector_d", context__.to_vec(N));
        Eigen::Matrix<double, Eigen::Dynamic, 1> dstudy(N);
        size_t dstudy_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < dstudy_j_1_max__; ++j_1__) {
            dstudy(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lub_unconstrain(get_base1(d_bnd, 1, "d_bnd", 1), get_base1(d_bnd, 2, "d_bnd", 1), dstudy);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable dstudy: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                dstudy = in__.vector_lub_constrain(get_base1(d_bnd, 1, "d_bnd", 1), get_base1(d_bnd, 2, "d_bnd", 1), N, lp__);
            else
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> dstudy = in__.vector_lub_constrain(get_base1(d_bnd, 1, "d_bnd", 1), get_base1(d_bnd, 2, "d_bnd", 1), N);
        size_t dstudy_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < dstudy_j_1_max__; ++j_1__) {
...
typedef model_random_ordered_namespace::model_random_ordered stan_model;
#ifndef USING_R
