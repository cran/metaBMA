...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 151, column 2 to column 52)",
                                                      " (in 'string', line 150, column 26 to line 152, column 1)",
                                                      " (in 'string', line 150, column 7 to line 152, column 1)",
                                                      " (in 'string', line 149, column 2 to column 56)",
                                                      " (in 'string', line 148, column 26 to line 150, column 1)",
                                                      " (in 'string', line 148, column 7 to line 152, column 1)",
                                                      " (in 'string', line 147, column 2 to column 87)",
                                                      " (in 'string', line 146, column 26 to line 148, column 1)",
                                                      " (in 'string', line 146, column 7 to line 152, column 1)",
                                                      " (in 'string', line 145, column 2 to column 68)",
                                                      " (in 'string', line 144, column 26 to line 146, column 1)",
                                                      " (in 'string', line 144, column 7 to line 152, column 1)",
                                                      " (in 'string', line 143, column 2 to column 53)",
                                                      " (in 'string', line 142, column 18 to line 144, column 1)",
                                                      " (in 'string', line 142, column 0 to line 152, column 1)",
                                                      " (in 'string', line 154, column 0 to column 20)",
                                                      " (in 'string', line 164, column 2 to column 58)",
                                                      " (in 'string', line 163, column 28 to line 165, column 1)",
                                                      " (in 'string', line 163, column 7 to line 165, column 1)",
                                                      " (in 'string', line 162, column 2 to column 62)",
                                                      " (in 'string', line 161, column 28 to line 163, column 1)",
                                                      " (in 'string', line 161, column 7 to line 165, column 1)",
                                                      " (in 'string', line 160, column 2 to column 99)",
                                                      " (in 'string', line 159, column 28 to line 161, column 1)",
                                                      " (in 'string', line 159, column 7 to line 165, column 1)",
                                                      " (in 'string', line 158, column 2 to column 76)",
                                                      " (in 'string', line 157, column 28 to line 159, column 1)",
                                                      " (in 'string', line 157, column 7 to line 165, column 1)",
                                                      " (in 'string', line 156, column 2 to column 59)",
                                                      " (in 'string', line 155, column 20 to line 157, column 1)",
                                                      " (in 'string', line 155, column 0 to line 165, column 1)",
                                                      " (in 'string', line 169, column 2 to column 56)",
                                                      " (in 'string', line 170, column 2 to line 172, column 72)",
                                                      " (in 'string', line 168, column 14 to line 173, column 1)",
                                                      " (in 'string', line 168, column 0 to line 173, column 1)",
                                                      " (in 'string', line 174, column 2 to column 61)",
...
class model_random_jzs final : public model_base_crtp<model_random_jzs> {
private:
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_random_jzs"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_random_jzs_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
        ...
        }}
      {
        ...
        lp_accum__.add(
          normal_lpdf<false>(y, add(d, multiply(X, beta)),
            stan::math::sqrt(add(SE2, pow(tau, 2)))));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"d\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << beta_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"g\",\"type\":{\"name\":\"vector\",\"length\":" << B << "},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_random_jzs_namespace::model_random_jzs;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_random_jzs_namespace::profiles__;
}
#endif
#endif
