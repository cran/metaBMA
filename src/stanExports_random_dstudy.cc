...
#include "stanExports_random_dstudy.h"

RCPP_MODULE(stan_fit4random_dstudy_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_random_dstudy")
